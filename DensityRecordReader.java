...
public class DensityRecordReader extends RecordReader<FloatWritable, Text> {
    ...
    @Override
    public FloatWritable getCurrentKey() throws IOException {
        return key;
    }
    ...
    public boolean nextKeyValue() throws IOException, InterruptedException {
        ...
        if (newSize == 0) {
        	...
        	key.set(Float.parseFloat(dataArray[0]));
